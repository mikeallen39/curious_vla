...
def run_pdm_score(args: List[Dict[str, Union[List[str], DictConfig]]]) -> List[pd.DataFrame]:
    ...
    for idx, (token) in enumerate(tokens_to_evaluate):
        ...
        try:
            ...
            score_row["pdms_v1"] = calculate_pdms(score_row)
...
def main(cfg: DictConfig) -> None:
    ...
    #         "tokens": tokens_list,
    #     }
    #     for log_file, tokens_list in scene_loader.get_tokens_list_per_log().items() if len(tokens_list) < 100
    # ]
    ...
    for log_file, tokens_list in scene_loader.get_tokens_list_per_log().items():
        ...
        while i < size:
            data_points.append({
                "cfg": cfg,
                "log_file": log_file,
                "tokens": tokens_list[i:min(i+100,size)],
            })
            i += 100
    ...
    # move pdms_v1 to last column
    pdm_score_df['pdms_v1'] = pdm_score_df.pop('pdms_v1')
    # add epdms_v2
    pdm_score_df['epdms_v2'] = pdm_score_df['score']
    ...
    # Construct base dataframe and add derived metrics
    ...
    logger.info(
        ...
        Finished running evaluation.
            ...
            Final average PDMS score of valid results: {pdm_score_df['pdms_v1'].mean()}.
            Final average EPDMS score of valid results: {pdm_score_df['score'].mean()}.
