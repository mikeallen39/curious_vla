...
output_json="$LATENCY_LOG_DIR/vllm_planning_latency_benchmark_${timestamp}.json"

python /home/ma-user/curious_vla/local/run_vllm_planning_latency_benchmark.py \
  --base-url "$BASE_URL" \
